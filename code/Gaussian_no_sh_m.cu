...
int main(int argc, char** argv) {
    ...
    cudaLaunchKernelGGL(Gaussian, gridSize, blockSize, 0, 0, d_src_img, d_dst_img, height, width, channels);
    cudaLaunchKernelGGL(Gaussian, gridSize, blockSize, 0, 0, d_dst_img, d_src_img, height, width, channels);
    ...
    cudaMemcpyAsync(dst_img, d_src_img, imgsize, cudaMemcpyDeviceToHost);
